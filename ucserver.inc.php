...
$sysconf['server'] = array(
    ...
    'max_node_all' => 20, // maximum connection to server
    'max_node_conn' => 1 // maximum connection for each node
    );

// nodes configuration
$sysconf['node']['slims-node1'] = array(
    'id' => 'slims-node1', // node id (must be UNIQUE, lowercase and not containing any spaces!)
    'name' => 'Perpustakaan SMAN 2 Tasikmalaya', // node name
    'password' => '2325f677e21c1613909c953eb03c57352259cc5d', // this hash created with SHA1 algoritm
    'baseurl' => 'http://smanda.dyndns.biz/perpus', // node base URL
    'ip' => '' // IP address of node
    );

$sysconf['node']['slims-node2'] = array(
    'id' => 'slims-node2', // node id (must be UNIQUE, lowercase and not containing any spaces!)
    'name' => 'Perpustakaan STIKES BTH Tasikmalaya', // node name
    'password' => '2325f677e21c1613909c953eb03c57352259cc5d', // this hash created with SHA1 algoritm
    //'baseurl' => 'http://localhost/senayan314', // node base URL
    'ip' => '' // IP address of node
    );
